...
class UserSeeder extends Seeder {
     ...
     */
    public function run() {
        $owner = User::factory()->create(['name' => 'Stijn De Leeuw', 'email' => 'sdeleeuw98@gmail.com', 'email_verified_at' => '2021-10-09 17:53:42', 'password' => '$2y$10$ALn.5h.pqG36EQnlLhcGD.ySj.d/Fhf1xepOGJxZfDZO4..hU1OAa', 'profile_photo_path' => 'profile-photos/nvPUrxaki1FpCMNLOJpidmaknEVuaErBzd267GTz.jpg']);
        ...
        $owner->syncRoles('owner');
        $owner = User::factory()->create(['name' => 'md', 'email' => 'matthias.delhoute@gmail.com', 'email_verified_at' => '2021-11-26 16:12:07', 'password' => '$2y$10$rQ3R/IEWbct4Gnh0OZjOhOTK3aEr.W5D05RtOkE6SQwXTHbXZdxJ.']);
        $owner->syncRoles('owner');
